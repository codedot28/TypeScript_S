...
const yuJin = new Idol('츄', 2);

console.log('--- sing ---');
console.log(yuJin.sing('신나게', 1)); // 츄가 신나게 노래를 부릅니다.
console.log(yuJin.sing('열정적으로', 2)); // 츄가 열정적으로 노래를 부릅니다.
console.log(yuJin.sing('기분 나쁘게', 3)); // Error: 잘못된 값 입니다. 기분 나쁘게